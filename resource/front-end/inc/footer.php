                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="widget widget-about">
                                <a href="demo1.html" class="logo-footer">
                                    <img src="<?php $app->asset('front-end/');  ?>images/logo_footer.png" alt="logo-footer" width="144"
                                        height="45" />
                                </a>
                ...
                <div class="footer-bottom">
                    ...
                    <div class="footer-right">
                        ...
                        <figure class="payment">
                            <img src="<?php $app->asset('front-end/');  ?>images/payment.png" alt="payment" width="159" height="25" />
                        </figure>
                    </div>
                </div>
            </div>
